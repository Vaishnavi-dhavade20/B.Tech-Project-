...
class UltrafastLaneDetectorV2():
	...
	@staticmethod
	def process_output(pred, cfg, local_width = 1, original_image_width = 2560, original_image_height = 1440):
	...
	@staticmethod
	def draw_lanes(input_img, lanes_points, lanes_detected, cfg, draw_points=True, original_image_width = 2560, original_image_height = 1440):
