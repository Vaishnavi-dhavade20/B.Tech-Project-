...
class SingleCamDistanceMeasure(object):
	...
	INCH = 0.39
	RefSizeDict = { 
					"Pedestrain" : (160*INCH, 50*INCH), 
					"Bicycle" : (98*INCH, 65*INCH),
					"Auto" : (100*INCH, 100*INCH),
					"Motorcycle" : (100*INCH, 100*INCH),
					"Car" : (150*INCH, 180*INCH ),
					"Van" : (150*INCH, 180*INCH ),
					"Tempo" : (150*INCH, 180*INCH ),
					"Tractor" : (150*INCH, 180*INCH ),
					"Bus" : (319*INCH, 250*INCH), 
					"Truck" : (346*INCH, 250*INCH), 
				 }

	def __init__(self, object_list=["Pedestrain", "Bicycle", "Auto", "Motorcycle", "Car", "Van", "Tempo", "Tractor", "Bus", "Truck"] ):
